...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dotenv-mode graphql-mode tuareg auto-complete dockerfile-mode typescript-mode php-mode exec-path-from-shell json-mode js-comint markdown-mode gitignore-mode rjsx-mode elpy ensime helm-projectile projectile ripgrep yafolding scala-mode yaml-mode helm))
